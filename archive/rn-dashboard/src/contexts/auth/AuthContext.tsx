...
export interface AuthContextType {
  ...
  register: ((userData: RegisterData) => Promise<{ success: boolean; message?: string }>) | undefined;
  logout: () => void;
...
export const nurseAuthConfig: AuthConfig = {
  appName: 'RN Dashboard',
  storageKey: 'rn-tokens',
  baseURL: process.env.REACT_APP_API_URL || 'https://localhost:5001',
  userRole: 'RN',
...
// Create NurseAuthProvider
export const AuthProvider = createAuthProvider(nurseAuthConfig);
