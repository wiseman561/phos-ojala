# Phos Healthcare Patient Portal
...
The portal integrates with the Phos Healthcare API for:
...
```bash
# Build image
docker build -t phos-patient-portal .

# Run container
docker run -p 80:80 phos-patient-portal
```
