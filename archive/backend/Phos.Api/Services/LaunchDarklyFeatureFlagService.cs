...
namespace Phos.Services.Implementations
{
    ...
    /// TODO: Fix LaunchDarkly namespace issues
    /// </summary>
    /*
    public class LaunchDarklyFeatureFlagService : IFeatureFlagService
    {
        ...
        private readonly LaunchDarkly.ServerSdk.LdClient _ldClient;
            ...
            ILogger<LaunchDarklyFeatureFlagService> logger)
        {
            ...
            _ldClient = new LaunchDarkly.ServerSdk.LdClient(_sdkKey);
        }
        ...
        public Task<bool> IsEnabled(string featureName)
        {
            try
            {
                ...
                var user = LaunchDarkly.ServerSdk.User.WithKey("default-user");
        ...
        public Task<bool> IsEnabledForUser(string featureName, string userId)
        {
            try
            {
                ...
                var user = LaunchDarkly.ServerSdk.User.WithKey(userId);
