...
namespace Phos.Data
{
    // ──────────────────────────────────────────────────────────────────────────────
    //  NOTE:
    //  • Inheriting from IdentityDbContext<ApplicationUser> registers AspNetUsers,
    //    AspNetRoles, etc. so UserManager / SignInManager work.
    //  • No need to declare DbSet<ApplicationUser>; the base class provides it.
    // ──────────────────────────────────────────────────────────────────────────────
    public class PhosDbContext : IdentityDbContext<ApplicationUser>
    {
        public PhosDbContext(DbContextOptions<PhosDbContext> options)
            : base(options)
        {
        }
        ...
        {
            // ⚠️ Must call base to let Identity configure its tables first
