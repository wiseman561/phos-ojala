...
builder.Services.AddScoped<Phos.Services.Interfaces.IPatientService, Phos.Services.Implementations.PatientService>();
builder.Services.AddScoped<Phos.Services.Interfaces.IAppointmentService, Phos.Services.Implementations.AppointmentService>();
builder.Services.AddScoped<Phos.Services.Interfaces.IMedicalRecordService, Phos.Services.Implementations.MedicalRecordService>();
builder.Services.AddScoped<Phos.Services.Interfaces.IHealthcarePlanService, Phos.Services.Implementations.HealthcarePlanService>();
