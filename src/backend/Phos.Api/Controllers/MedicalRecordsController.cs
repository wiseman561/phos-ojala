...
namespace Phos.Api.Controllers
{
    ...
    public class MedicalRecordsController : ControllerBase
    {
        ...
        [HttpGet("provider/{providerId}/types")]
        [Authorize(Roles = "Provider,Admin")]
        ...
        [Authorize(Roles = "Provider,Admin")]
        public async Task<ActionResult<PrescriptionDto>> AddPrescription(string recordId, [FromBody] PrescriptionDto prescriptionDto)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            var prescription = await _medicalRecordService.AddPrescriptionToRecordAsync(recordId, prescriptionDto);
            if (prescription == null)
            {
                return BadRequest("Failed to add prescription to record");
            }
