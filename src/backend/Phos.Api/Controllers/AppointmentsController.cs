...
namespace Phos.Api.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<AppointmentDto>> Create(AppointmentCreateDto appointmentDto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, AppointmentUpdateDto appointmentDto)
        {
